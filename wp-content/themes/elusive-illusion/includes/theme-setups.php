...
if (!function_exists('eli_wptheme_scripts')) :
  ...
  function eli_wptheme_scripts() {
    ...
    wp_enqueue_style('owl-css', ELUSICVE_THEME_ASSETS . 'css/owl.carousel.css');
    ...
    wp_enqueue_script('imagesloaded', ELUSICVE_THEME_ASSETS . 'js/vendor/imagesloaded.pkgd.min.js', array('jquery'), 3.0, TRUE);
