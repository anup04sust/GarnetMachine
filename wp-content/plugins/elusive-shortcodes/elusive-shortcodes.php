...
require_once( 'inc/els_heading.php' );
require_once( 'inc/els_list.php' );
require_once( 'inc/els_table.php' );
require_once( 'inc/els_dropcap.php' );
...
class BootstrapShortcodes{
    ...
    function add_options_defaults() {
            $arr = array(
               ...
               'chk_default_options_heading'   => '0',
               'chk_default_options_dropcap'   => '0',
